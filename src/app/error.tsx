...
export default function Error({ error, reset }: ErrorProps): React.JSX.Element {
  ...
  return (
    <div className="flex-grow flex items-center justify-center py-12 animate-slide-up">
      <Card className="max-w-md w-full text-center flex flex-col items-center gap-6 p-10 border-app-error/20 bg-app-error-bg/5">
        ...
        <Heading level={1} variant="headline-md" subheading="A systemic exception occurred while processing this experience. Our curation engines are investigating.">
