...
import { Clock, ArrowUp, PlusCircle, TrendingUp, MoreHorizontal } from "lucide-react";
    ...
    <div className="animate-slide-up flex flex-col gap-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <Heading
          level={2}
          variant="display-lg"
          subheading="Your curated portfolio of exclusive experiences."
        >
          Welcome back, Alex.
        </Heading>
        <div className="flex gap-4">
          <div className="bg-app-surface/80 border border-app-card-border backdrop-blur-md rounded-full px-6 py-2.5 flex items-center gap-2 shadow-sm">
            <TrendingUp className="w-4 h-4 text-app-brand" />
            <span className="text-[10px] font-bold text-app-fg uppercase tracking-wider font-label-caps">
              +12% this month
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Hero Card (Span 8) */}
        <Card className="p-0 overflow-hidden md:col-span-8 relative group flex flex-col min-h-[350px]">
          ...
          <div className="relative z-10 flex flex-col h-full justify-end p-8 mt-auto gap-4">
            <div className="flex items-center flex-wrap gap-2">
              <Badge variant="brand">Next Departure</Badge>
              <span className="text-xs font-semibold text-app-fg flex items-center gap-1 bg-app-surface/70 backdrop-blur-md px-3 py-1 rounded-full border border-app-border">
        ...
        {/* Stats Card (Span 4) */}
        <Card className="md:col-span-4 flex flex-col justify-between p-8">
          <div>
            <h4 className="text-[10px] font-bold text-app-muted uppercase tracking-wider font-label-caps mb-6">
      ...
      {/* Secondary Grid */}
      <div>
        <h3 className="text-xl font-bold tracking-tight text-app-fg mb-6 font-headline-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <button
            ...
            className="glass-panel hover:bg-app-surface-variant/40 rounded-2xl p-6 flex flex-col items-center justify-center text-center cursor-pointer border border-dashed border-app-border transition-all duration-300 min-h-[220px]"
          >
            <PlusCircle className="w-10 h-10 text-app-muted mb-3 group-hover:scale-105 transition-transform" />
            <h4 className="text-base font-bold text-app-fg font-body-lg mb-1">
              Draft New Itinerary
            </h4>
            <p className="text-xs text-app-muted font-body-md">
