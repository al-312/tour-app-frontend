...
export default function RootLayoutClient({ children }: RootLayoutClientProps): React.JSX.Element {
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-64">
        ...
        <footer className="mt-auto border-t border-app-border py-6 px-6 bg-app-surface flex flex-col sm:flex-row items-center justify-between gap-4 transition-colors duration-300">
          <span className="text-xs text-app-muted">
            © 2026 AuraTours Technologies. All rights reserved. Strict-safety travel certified.
          </span>
          <div className="flex gap-4">
            <Link href="/privacy" className="text-xs text-app-muted hover:text-app-fg transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-xs text-app-muted hover:text-app-fg transition-colors">
              Terms of Service
            </Link>
          </div>
        </footer>
